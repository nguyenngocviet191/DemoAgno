...
memory_db=PgMemoryDb(table_name="agent_memory", db_url=DB_URL,schema="public")
...
# agent1_memory = AgentMemory(
#     user_id="user_1",
#     db=memory_db,
# )
# agent1_memory.update_memory(f"Hello from Agent 1! ID: {agent1_id}", force=True)

# # Tạo agent thứ hai
# agent2_id = str(uuid.uuid4())  # Tạo ID duy nhất cho agent 2
# agent2_memory = AgentMemory(
#     user_id="user_2",
#     db=memory_db,
# )
# agent2_memory.update_memory(f"Hello from Agent 2! ID: {agent2_id}", force=True)

# # Truy vấn và hiển thị dữ liệu từ cơ sở dữ liệu
# def display_memories(agent_memory: AgentMemory, agent_id: str):
