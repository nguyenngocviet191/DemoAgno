...
from .async_router import get_async_playground_router
from .settings import PlaygroundSettings
from .sync_router import get_sync_playground_router
...
class Playground:
    ...
    def get_app(self, use_async: bool = True, prefix: str = "/v2") -> FastAPI:
        print (f"get_app prexit {prefix}")
        if not self.api_app:
    ...
    def create_endpoint(self, endpoint: str, prefix: str = "/v2") -> None:
