    ...
    messageContent = (
      <div className="flex w-full flex-col gap-4">
        <div className="flex flex-col gap-2 group">
          ...
          <div className="hidden group-hover:flex w-full justify-start gap-2">
...
const UserMessage = memo(({ message }: MessageProps) => {
  // console.log('message:', message)
  return (
    <div className="flex flex-col gap-2 pt-4  max-md:break-words ">
      <div className="ml-auto flex flex-col gap-x-3 group">
        ...
        <div className="hidden group-hover:flex w-full justify-end gap-2">
          <button className="text-gray-100 hover:text-gray-700">
            <Reply className="size-3" />
          </button>
          <button className="text-gray-100 hover:text-gray-700">
      ...
      {/* <div className="flex w-full flex-col gap-4"> */}
      <div className="ml-auto w-1/3 flex-col gap-4">
        {/* <MarkdownRenderer>{message.content}</MarkdownRenderer> */}
