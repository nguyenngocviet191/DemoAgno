...
const useAIChatStreamHandler = () => {
  ...
  const handleStreamResponse = useCallback(
    async (input: string | FormData, attachedFiles: File[] = []) => {
      setIsStreaming(true)
      ...
      console.log(`nhận ${(attachedFiles.length)} file(s)`);
      ...
      console.log(files);
      //test anh
      // const dummyImage= new File(["dummy content"], "test.png", { type: "image/png" });
      // console.log(URL.createObjectURL(dummyImage));
      //
       addMessage({
        ...
        images: files
          ...
          .map((file) => ({
            revised_prompt: '',
            url: URL.createObjectURL(file), // Chỉ cần URL để hiển thị ảnh
          })),
